...
class TrojanMap {
public:
    bool flag = false; // control entering animation
    ...
    void TravellingTrojan_helper(std::vector<std::string> &ids,
                                 std::pair<double, std::vector<std::vector<std::string>>> &results,
                                 bool visited[], std::vector<std::string> &path, double &min_dist, double dist);

    void TravellingTrojan_2opt_helper(vector<std::string> &path, int start, int end);
    ...
    bool CycleDetection_helper(std::string &id, std::string &parent, std::unordered_map<std::string, bool> &visited,
    ...
    void FindKClosestPoints_(std::vector<Node> &nameData, int left, int right, int k, std::string souceId);

    //----------------------------------------------------- User-defined functions

    std::pair<double, std::vector<std::vector<std::string>>> TravellingTrojan_genetic(std::vector<std::string> &location_ids);
    void init_group(std::vector<std::string> &location_ids,int citynum);
